...
public class ArrayDeque<E> implements Deque<E> {
    private final int INTIAL_CAPACITY = 7;
    private int size;
    Object[] elements;
    private int head;
    private int tail;
    ...
    public ArrayDeque() {
        this.elements = new Object[INTIAL_CAPACITY];
        int middle = INTIAL_CAPACITY / 2;
        head = tail;
    }
    ...
    private void ensureIndex(int realIndex) {
        if (realIndex < this.head || realIndex > this.tail) {
            throw new IndexOutOfBoundsException("Index out of boundss for index: " + (realIndex - this.head));
        }
    }
